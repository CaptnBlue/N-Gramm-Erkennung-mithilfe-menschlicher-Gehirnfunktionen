...
public class CompareSequence {
    ...
    public static void compareLtms() throws IOException {
        ...
        sequenzen1.retainAll(sequenzen3); // ... und 3
    ...
    public static void calculateStats() throws IOException {
        ...
        // 2. Alle N-Gramme nach Counter sortieren -> für Rangberechnung
        ...
        int range = schnittRang.isEmpty() ? 0 : schnittRang.get(schnittRang.size() - 1) - schnittRang.get(0);
