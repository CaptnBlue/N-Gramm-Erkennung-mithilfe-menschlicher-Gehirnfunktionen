...
public class Constants {
    ...
    public final static int NGRAMM_SIZE_FROM = 1;
    public final static int NGRAMM_SIZE_TO = 5;
    public final static int SHORTTOLONG_THRESHOLD = 4; // 0 benutzen um alle aufzunehmen
    ...
    public final static boolean WITH_HASHEDEDGES = true; // true -> HashedEdges; false -> absolute Häufigkeiten
    public static int HISTORY = 2; // gibt anzahl an wie vielke ngramme zurück angeschaut werden
